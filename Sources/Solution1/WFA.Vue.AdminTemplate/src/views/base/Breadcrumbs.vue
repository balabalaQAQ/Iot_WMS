          ...
          <b-card>
            ...
            <b-table :hover="hover"
              ...
              <template slot="operation" slot-scope="data">
                <b-button variant="primary" size="sm" @click="updateItem(data.item.id)">编辑与明细</b-button>&nbsp;
            
                <b-button variant="danger" size="sm" @click="deleteItem(data.item.id)">删除</b-button>
              </template>
            </b-table>
...
const uri ='https://localhost:5001/api/WeatherForecast';
  ...
  export default {
    ...
    methods: {
      ...
      createData() {
        this.$router.push({
           name: "MembershipIns",
           params: { level:this.mumitems[0].levelList}
         });
